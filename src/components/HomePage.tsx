      ...
      <div className="relative z-10 flex-grow">
        ...
        <div className="w-full px-4 pb-12">
          ...
          >
            {/* 3D Printing Panel */}
            <motion.div
              className="w-full md:w-[450px] bg-gray-900/90 backdrop-blur-sm rounded-lg overflow-hidden shadow-[0_0_15px_rgba(255,87,36,0.2)] hover:shadow-[0_0_25px_rgba(255,87,36,0.4)] transition-shadow"
